...
| `qiskit-aer` | IBM noise model simulation (ibm_fez) |
| `scikit-learn` | Gaussian Process Regressor (Matérn kernel) |
| `scikit-optimize` | Bayesian Optimization framework |
| `NumPy / SciPy` | Numerical computation + statistical testing |
| `Matplotlib` | Convergence curves, regret plots, heatmaps |
